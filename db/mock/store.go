...
// Source: github.com/ryanma3003/simplebank/db/sqlc (interfaces: Store)
//
...
func (m *MockStore) ListEntrys(arg0 context.Context, arg1 db.ListEntrysParams) ([]db.Entries, error) {
	m.ctrl.T.Helper()
...
func (mr *MockStoreMockRecorder) ListEntrys(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
